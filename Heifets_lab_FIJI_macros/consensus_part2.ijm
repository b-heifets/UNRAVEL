...
// consensus_part2 (Daniel Rijsketic Jan. 17, 2022; Heifets lab)
//===================================================
...
open(consensusDir+"Result_of_seg_ilastik_1.tif");
imageCalculator("Add create stack", "seg_ilastik_3.tif","Result_of_seg_ilastik_1.tif");

saveAs("Tiff", consensusDir+"Result_of_seg_ilastik_3.tif");
