...
def parse_args():
    ...
    parser.add_argument('-o', '--output', help='Output path (image type determined by extension). Default: None', default=None, action=SM)
    parser.add_argument('-d', '--dtype', help='Data type for .nii.gz. Default: None. Options: np.uint8, np.uint16, np.float32.', default=None, action=SM)
