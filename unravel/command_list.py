...
def main():
    ...
    commands = {
        "Registration": {
            "reg_prep": {
                "module": "unravel.register.prep_reg",
        ...
        "Voxel-wise stats": {
            ...
            "vstats_prep": {
                "module": "unravel.voxel_stats.prep_vstats",
        ...
        "Cluster-wise stats": {
            ...
            "cluster_validation": {
                "module": "unravel.cluster_stats.validate_clusters",
                "description": "Validate clusters w/ cell/label density measurements.",
                "common": True
            },
            "cluster_summary": {
                "module": "unravel.cluster_stats.valid_clusters_summary",
            ...
            "cluster_crop": {
                "module": "unravel.cluster_stats.crop_clusters",
        ...
        "Image I/O": {
            ...
            "io_nii": {
                "module": "unravel.image_io.nii_io",
