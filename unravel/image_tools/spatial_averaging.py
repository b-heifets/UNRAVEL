...
def main():
    ...
    if args.xy_res is None or args.z_res is None:
        img, xy_res, z_res = load_3D_img(args.input, channel=args.channel, return_res=True, verbose=args.verbose)
    else:
        img = load_3D_img(args.input, channel=args.channel, verbose=args.verbose)
