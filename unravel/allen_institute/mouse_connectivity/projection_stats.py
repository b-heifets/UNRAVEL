...
def main():
    ...
    for dir_path in dir_paths:
        ...
        for region_id in region_ids:
            ...
            # projection density = sum of detected pixels / count of all pixels in region
            ...
            # projection energy = sum of detected pixel intensity / count of all pixels in region
