...
function warpclartoallen()
{
    ...
    if [[ ! -z ${channel} ]]; then
        ...
        ResampleImage 3 ${inimg} ${res_vox} 0.025x0.025x0.025 0 ### Could try 0.010x0.010x0.010 for 10 um atlas
...
# 1) Warp Gubra labels to original CLARITY ###
	...
	allenref=${atlasdir}/ara/gubra/gubra_template_25um.nii.gz ### changed average template
...
###
printf "\n Warping of CLARITY image to Gubra space and generation of ${wrpclar} done in ${DIFF} minutes. \
Have a good day! \n"
