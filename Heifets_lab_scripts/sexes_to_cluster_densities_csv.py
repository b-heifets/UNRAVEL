...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description='Merge densities and sex information from CSVs.')
    parser.add_argument('-i', '--input_csv', help='CSV with cell or fiber densities.', metavar='')
    parser.add_argument('-s', '--sex_info_csv', help='CSV with "Samples" and "Sex" columns.', metavar='')
