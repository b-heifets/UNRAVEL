...
def main():
    ...
    parser.add_argument("-p", "--pattern", help="The pattern to match files, e.g., '*.txt'", required=True, metavar='')
    parser.add_argument("-s", "--source", help="The source directory to search files in. Default: current working dir", default=".", metavar='')
    parser.add_argument("-d", "--destination", help="The destination directory to copy files to. Default: current working dir", default=".", metavar='')
