...
for i in clusters:
    ...
    seg_in_cluster_cropped_output = str(sys.argv[4]+'/consensus_cropped/3D_counts/crop_consensus_'+str(sys.argv[5])+'_native_cluster_'+str(i)+'_3dc/crop_consensus_'+str(sys.argv[5])+'_native_cluster_'+str(i)+'.nii.gz')
