    ...
    with Live(progress):
        for sample_path in samples:
            ...
            if args.native_idx and Path(args.native_idx).exists():
                ...
                native_cluster_index = to_native(sample_path, args.reg_outputs, args.fixed_img, args.moving_img, args.metadata, args.reg_res, args.miracl, args.zoom_order, args.interpol, output=native_idx_path)
