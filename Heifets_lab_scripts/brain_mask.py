...
def parse_args():
    ...
    parser.add_argument('-o', '--output', help='Output file name. Default: autofl_50um_masked.nii.gz', default=None, metavar='')
...
def main():
    ...
    if args.output is None:
        args.output = f"autofl_{args.res}um_masked.nii.gz"
    ...
    with Live(progress):
        for sample in samples:
            ...
            if args.tif_dir is "reg_input/autofl_50um_tifs": # default
            ...
            if args.ilastik_prj is 'reg_input/brain_mask.ilp': # default
            ...
            decorated_ilastik_segmentation(autofl_tif_directory, ilastik_project, seg_output_dir, args.ilastik_log)
