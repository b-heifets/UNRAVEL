...
def parse_arguments():
    ...
    parser.add_argument('-min', '--display_range_min', help='Minimum display range value.', type=float)
    parser.add_argument('-max', '--display_range_max', help='Maximum display range value.', type=float)
