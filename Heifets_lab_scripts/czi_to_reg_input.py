...
def load_czi_resample_save_nii(sample_dirs, channel, ds_factor, xy_res, z_res, target_resolution, output_name):
    '''
    ...
    # Resample
    resampled_image = resample(image, ds_factor, xy_res, z_res, target_resolution)
...
def main(sample_dirs):
    ...
    load_czi_resample_save_nii(sample_dirs, args.channel, args.ds_factor, args.xy_res, args.z_res, args.res, args.output)
...
# Consider splitting up the load_czi_resample_save_nii function so that it can be reused for other scripts like the following:
