...
def parse_args():
    ...
    parser.add_argument("-o", "--output", help="Path to save the output TIFF file.", default="output.tif", )
    parser.add_argument("-rb", "--rb_radius", help="Radius of rolling ball in pixels.", default=4, type=int)
    parser.add_argument("-g1", "--sigma1", help="Sigma for the first Gaussian blur in DoG.", default=1.0, type=float)
    parser.add_argument("-g2", "--sigma2", help="Sigma for the second Gaussian blur in DoG.", default=2.0, type=float )
