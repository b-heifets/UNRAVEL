...
def parse_args():
    ...
    parser.add_argument('-e','--exp_dirs', help='List of dirs containing sample?? folders', nargs='*', default=None, action=SM)
...
def parse_args():
    ...
    parser.add_argument('-md', '--metadata', help='pathmetadata.txt. Default: ./parameters/metadata.txt', default="./parameters/metadata.txt", action=SM)
    parser.add_argument('-v', '--verbose', help='Increase verbosity. Default: False', action='store_true', default=False)
...
def main():
    ...
    # Get samples for all experiment dirs
